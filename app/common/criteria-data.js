...
},
{
    type: "Outcome",
    category: "Efficiency",
    criteria: "Cost/benefit ratio",
    explanation: "Economic viability of adaptation measures in terms of their costs and benefits ratio. Adaptation measures are assessed based on whether they can reach their objectives in the most efficient way in economic terms (e.g. to achieve objectives at least cost) and have a balanced cost/benefits ratio. The benefits and effectiveness of adaptation measures are compared to costs and effort. (Example for measurement: Adaptation measures are considered cost-efficient if they bring higher benefits in comparison to its costs of implementation.)",
    evaluation: undefined,
    weight: 1
},
{
    ...
    category: "Efficiency",
    criteria: "Total cost",
    explanation: "The costs of the adaptation measures; direct costs, further economic costs and external costs, as a base to rank their relative merit. The direct costs can be further split in investment costs, maintenance costs and also costs of administrative implementation of adaptation measures. (Example for measurement: Total economic value of the design, implementation, execution, performance monitoring and evaluation of the adaptation practice.)",
    evaluation: undefined,
    weight: 1
},
{
...

{
    type: "Outcome",
    category: "Equity",
    criteria: "Proportion of beneficiaries",
...

{
    type: "Outcome",
    category: "Equity",
    criteria: "Attention to the most vulnerable groups",
...

{
    type: "Process",
    category: "Adaptive capacity",
    criteria: "Capacity of institutions/ organisations",
...

{
    type: "Process",
    category: "Dependencies",
    criteria: "(General) Prerequisite requirements",
